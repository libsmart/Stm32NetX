...
#if defined(LIBSMART_STM32NETX_ENABLE_DNS)
        ULONG dns1_address = LIBSMART_STM32NETX_DEFAULT_DNS1_ADDRESS;
        ULONG dns2_address = LIBSMART_STM32NETX_DEFAULT_DNS2_ADDRESS;
#endif
    };
