...
#define LIBSMART_STM32NETX_PACKET_POOL_MEM_SECTION __attribute__((section(".data")))
#define LIBSMART_STM32NETX_PACKET_POOL_AUX_MEM_SECTION __attribute__((section(".data")))
#define LIBSMART_STM32NETX_DHCP_MEM_SECTION __attribute__((section(".data")))
...
#define LIBSMART_STM32NETX_DEFAULT_DNS1_ADDRESS IP_ADDRESS(0,0,0,0)
#define LIBSMART_STM32NETX_DEFAULT_DNS2_ADDRESS IP_ADDRESS(0,0,0,0)
